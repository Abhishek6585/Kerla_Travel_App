  ...
  const settingsCategories = [
    {
      ...
      items: [
        ...
        { 
          ...
          subtitle: "India Emergency Services", 
          hasArrow: true,
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="text-center space-y-3">
            ...
            <div>
              <h3 className="font-semibold">India Travel Tracker</h3>
              <p className="text-sm text-muted-foreground">Incredible India, Your Own Journey</p>
            </div>
          </div>
        </CardContent>
      </Card>
